...
import rs.example.playlistmaker.databinding.PlaylistFragmentBinding
    ...
    private fun render(playlist: PlayList) {
        ...
        binding.tracksBottomSheet.doOnNextLayout {
            ...
            val openMenuHeightFromBottom =
                binding.root.height - openMenuLocation[1] - resources.getDimensionPixelSize(R.dimen.i_p_8)
